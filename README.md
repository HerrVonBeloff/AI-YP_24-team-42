...
Метрики, как правило, выходили на плато в диапозоне одних и тех же значений на протяжении всех экспериментов. IS колебаллся в районе 1.8, CLIP колебался на укровне 0.18, FID колебался чуть шире: от 1000 до 1200. Причем метрики IS и FID (ранее мы не использовали CLIP) значительно хуже, чем значения метрик ранее (IS $\approx$ 0.20, FID $\approx$ 3.3). Такое постоянство метрик дополнительно показывает, что своими улучшениями мы не затронули главную первопричину низкого качества модели.
